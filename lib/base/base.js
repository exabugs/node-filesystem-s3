...
Base.prototype.before_findOne = function (context, params, callback) {
  ...
  this.validator(this.fields, params.query, function (err, query) {
    callback(err, params);
  });
};
...
Base.prototype.do_findOne = function (context, params, callback) {
  ...
  this.collection().findOne(query, options, function (err, object) {
    callback(err, object);
  });
};
...
Base.prototype.do_find = function (context, params, callback) {
  var query = params.query || {};
  var options = {fields: params.fields};
  this.collection().find(query, options).toArray(function (err, objects) {
...
Base.prototype.do_destroy = function (context, params, callback) {
  var query = params.query || {};
  this.findAndRemove(query, function (err, object) {
    callback(err, object);
  })
};
