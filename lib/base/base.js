...
Base.prototype.findOne = function (params, callback) {
  ...
  async.waterfall([
      ...
      function (params, next) {
        self.do_findOne(self, params, function (err, object) {
          next(err, object);
        })
      },
...
Base.prototype.find = function (params, callback) {
  ...
  async.waterfall([
      ...
      function (params, next) {
        self.do_find(self, params, function (err, objects) {
          next(err, objects);
        })
      },
...
Base.prototype.update = function (params, callback) {
  ...
  async.waterfall([
      ...
      function (params, next) {
        self.do_update(self, params, function (err, object) {
          next(err, object);
        })
      },
      function (object, next) {
        self.after_update(self, params, object, function (err, object) {
          next(err, object);
        })
      }],
    function (err, object) {
...
Base.prototype.destroy = function (params, callback) {
  ...
  async.waterfall([
      ...
      function (params, next) {
        self.do_destroy(self, params, function (err, object) {
          next(err, object);
        })
      },
      function (object, next) {
