...
S3Index.prototype.before_create = function (context, params, callback) {
  var self = this;
  S3_Action.before_upsert.call(self, context, params, 'create', callback);
};
...
S3Index.prototype.after_update = function (context, params, object, callback) {
  var self = this;
  S3_Action.after_upsert.call(self, context, params, object, 'update', callback);
};

S3Index.prototype.after_create = function (context, params, object, callback) {
  var self = this;
  S3_Action.after_upsert.call(self, context, params, object, 'create', callback);
};
