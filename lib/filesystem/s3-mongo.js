...
var S3Index = DB.inherits(Base, function (db, name) {
  ...
  if (!this.initialized[this.name]) {
    this.super_.constructor(db);
    this.fields = this.fields.concat(fields);
    this.s3 = new S3(name);
    this.initialized[this.name] = true;
  }
  return this;
});
...
S3Index.prototype.after_findOne = function (params, object, callback) {
  ...
  async.waterfall([
      function (next) {
        self.super_.after_findOne(params, object, function (err, params, object) {
...
S3Index.prototype.before_update = function (params, callback) {
  ...
  async.waterfall([
      function (next) {
        self.super_.before_update(params, function (err, params) {
          next(err, params);
        });
      },
